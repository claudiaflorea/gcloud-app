...
<form action="signup" method="post" action="${pageContext.request.contextPath }/new-user" 
style="display: flex; text-align: left;  left: 35%; right: 35%; width: 70%;   top: 20%;   position: absolute;   height: 500px;  font-size: xxx-large;">
	...
	${error }
			<table style="with: 50%;  display: flex;  font-size: xx-large; justify-content: center;  margin: 10%;" cellpadding="2" cellspacing="2">
				<tr>
					<td>First Name</td>
					<td><input type="text" name="first_name" style="font-size: x-large" /></td>
				</tr>
				<tr>
					<td>Last Name</td>
					<td><input type="text" name="last_name" style="font-size: x-large"/></td>
				</tr>
				<tr>
					<td>UserName</td>
